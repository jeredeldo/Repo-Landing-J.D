...
import { UserCheck, Award, Code, Sparkles, CheckCircle2, ShieldCheck, Zap, Laptop } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            {personalData.fullBio.map((paragraph, index) => (
              <p key={index} className="glass-card p-6 rounded-2xl border border-slate-800/80">
                {paragraph}
              </p>
            ))}
