      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight uppercase">
            Iniciá tu proyecto con <span className="text-gold-gradient">ALBION WEB</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <div className="glass-card p-8 rounded-3xl border border-white/10 space-y-6 hover:border-amber-500/30">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-2xl bg-zinc-900/80 border border-zinc-800 hover:border-amber-500/40 transition-all group"
                >
                  <div className="w-12 h-12 rounded-xl bg-gold-gradient text-black flex items-center justify-center font-black group-hover:scale-110 transition-transform">
                    <Mail className="w-6 h-6" />
                  </div>
                  <div className="flex-1">
                    <span className="text-[11px] text-zinc-400 block font-mono uppercase tracking-wider">Email Oficial</span>
                    <span className="text-sm font-bold text-zinc-200 group-hover:text-amber-300 transition-colors">
                      {personalData.email}
                    </span>
                  </div>
                </a>
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-2xl bg-zinc-900/80 border border-zinc-800 hover:border-amber-500/40 transition-all group"
                >
                  <div className="w-12 h-12 rounded-xl bg-zinc-800 border border-zinc-700 flex items-center justify-center text-amber-400 group-hover:scale-110 transition-transform">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="glass-card p-8 rounded-3xl border border-white/10 hover:border-amber-500/30">
              <h3 className="text-xl font-bold text-white mb-6 uppercase tracking-wider">Pedir Presupuesto</h3>

              {submitted ? (
                <div className="p-6 rounded-2xl bg-zinc-900 border border-amber-500/40 text-center space-y-3">
                  ...
                  <p className="text-sm text-zinc-300">
                    Gracias por comunicarte con ALBION WEB. Nos pondremos en contacto a la brevedad a <span className="font-bold text-amber-300">{formData.email || 'tu email'}</span>.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-black border border-zinc-800 text-white placeholder-zinc-600 focus:outline-none focus:border-amber-400 text-sm transition-all"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-black border border-zinc-800 text-white focus:outline-none focus:border-amber-400 text-sm transition-all"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-black border border-zinc-800 text-white placeholder-zinc-600 focus:outline-none focus:border-amber-400 text-sm transition-all resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 rounded-xl bg-gold-gradient text-black font-black text-xs uppercase tracking-wider transition-all shadow-xl shadow-amber-500/20 hover:shadow-amber-500/40 flex items-center justify-center gap-2 hover:scale-102 active:scale-98 disabled:opacity-50"
                  >
                    {loading ? (
