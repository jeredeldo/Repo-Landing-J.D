        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="inline-flex items-center">
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-950/60 border border-blue-800/50 text-blue-400 text-xs font-semibold tracking-wide shadow-sm">
            ...
            {/* Nombre y Título (Jeremías Del Do junto siempre) */}
            <motion.h1
            ...
            <motion.div
              variants={itemVariants}
              className="mt-10 pt-6 border-t border-slate-800/60 w-full flex flex-wrap items-center gap-2 text-xs text-slate-400"
            >
              <span className="font-semibold text-slate-400 mr-2">Stack Principal:</span>
